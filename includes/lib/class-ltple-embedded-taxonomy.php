  ...
  /**
	...
	public function register_taxonomy () {
        ...
        $labels = array(
            ...
            'update_item' => sprintf( __( 'Update %s' , 'live-template-editor-embedded' ), $this->single ),
            'add_new_item' => sprintf( __( 'Add New %s' , 'live-template-editor-embedded' ), $this->single ),
            'new_item_name' => sprintf( __( 'New %s Name' , 'live-template-editor-embedded' ), $this->single ),
            'parent_item' => sprintf( __( 'Parent %s' , 'live-template-editor-embedded' ), $this->single ),
            'parent_item_colon' => sprintf( __( 'Parent %s:' , 'live-template-editor-embedded' ), $this->single ),
            'search_items' =>  sprintf( __( 'Search %s' , 'live-template-editor-embedded' ), $this->plural ),
            'popular_items' =>  sprintf( __( 'Popular %s' , 'live-template-editor-embedded' ), $this->plural ),
            'separate_items_with_commas' =>  sprintf( __( 'Separate %s with commas' , 'live-template-editor-embedded' ), $this->plural ),
            'add_or_remove_items' =>  sprintf( __( 'Add or remove %s' , 'live-template-editor-embedded' ), $this->plural ),
            'choose_from_most_used' =>  sprintf( __( 'Choose from the most used %s' , 'live-template-editor-embedded' ), $this->plural ),
